...
$nextID = $row['maxID'] + 1;
$maYC = "YCNNL" . str_pad($nextID, 2, '0', STR_PAD_LEFT);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    mysqli_query($conn, "INSERT INTO yeucaunhapnguyenlieu (ngayYeuCau, trangThai) VALUES ('$ngayYC', 0)");
    ...
    foreach ($products as $p) {
        ...
        $sqlDetail = "INSERT INTO chitietyecaunhapnguyenlieu (idYeuCauNhapNL, maNL, soLuongNhap) 
