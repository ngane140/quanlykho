        ...
        if (products.length > 0) {
            products.forEach(function(product) {
                ...
                suggestion.onclick = function() {
                    ...
                    document.getElementById("timSP").value = product.tenNguyenLieu; // Điền tên sản phẩm vào ô tìm kiếm
                    document.getElementById("maSP").value = product.maNL; // Lưu mã sản phẩm
...
xhr.open("POST", "../class/clsthemYCnhapNL.php", true);
xhr.onload = function() {
